...
class Rocket extends React.Component<any, any> {
    getIconHtml = function(rocketDirection: string, active: boolean = false) {
        ...
        let rocketClass;
        if(active) {
            rocketClass = rocketDirection + " bi bi-cursor-fill";
            html = (
                <svg className={rocketClass} width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            rocketClass = rocketDirection + " bi bi-cursor";
            html = (
                <svg className={rocketClass} width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
